...
export const metadata: Metadata = {
  ...
  description:
    'Palpites de apostas esportivas com análise quantitativa. Prognósticos para futebol baseados em modelo estatístico com probabilidades, edge e apostas de valor para gols, escanteios, cartões e mais.',
  alternates: {
